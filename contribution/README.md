...
## پیشنهاد پست برای ترجمه
 اگر قصد ترجمه پستی مرتبط با LLMها را دارید ابتدا آن را در صفحه‌ی  [پست‌های پیشنهادی](contribution/blog-posts.md) ثبت کنید تا از ترجمه مجدد پست‌های تکراری جلوگیری شود.
...
برای مشارکت در ترجمه پست‌ها ابتدا صفحه [پست‌های پیشنهادی](contribution/blog-posts.md) را بررسی کنید و یک پست را به دلخواه خود انتخاب کنید. 
...
حال باید فایل [پست‌های پیشنهادی](contribution/blog-posts.md) بروزرسانی کنید تا به دیگران اطلاع دهید که شما در حال ترجمه این پست هستید. برای این کار:

-  ابتدا در رپوی Fork شده خود یک برنچ جدید درست کنید.
- بعد از آن به صفحه [پست‌های پیشنهادی](contribution/blog-posts.md)  رفته و  وضعیت پست انتخابی خود را به "در حال ترجمه" تغییر دهید و شماره PR باز شده در مرحله قبل را برای آن ثبت کنید.

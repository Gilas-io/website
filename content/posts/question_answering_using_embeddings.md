...
متن می‌تواند به بسیاری از روش‌ها جستجو شود. این notebook نمونه از جستجوی مبتنی بر embeddings استفاده می‌کند. embeddings‌ها راهی ساده برای پیاده‌سازی جستجوی داخل متون هستند.

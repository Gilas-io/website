...
---|---|---
`gpt-4o` | قدرتمندترین مدل از خانواده GPT4 با قابلیت های چندگانه٬ سریع‌تر از مدل `gpt-4-turbo` با ۵۰٪ هزینه‌ی کمتر ازین مدل و دارای عملکرد بهتر در زبان‌های غیر انگلیسی | ۱۲۸.۰۰۰ توکن

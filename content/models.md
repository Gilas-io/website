...
`gpt-4o-mini` | مرقوم به صرفه‌ترین مدل از خانواده GPT4 که از لحاظ هزینه ارزانتر از مدل `GPT-3.5-Turbo` بوده و در عین حال از قدرت بسیار بیشتر و قابلیت دیدن (vision) نیز برخوردار است. کمتری  | ۱۲۸.۰۰۰ توکن

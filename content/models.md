...
| `claude-3-5-sonnet-latest` | Anthropic | مدلی قدرتمندترین با توانایی‌های پیشرفته در استدلال، کدنویسی و پردازش تصویر. این مدل با سرعت دو برابر نسبت به Claude 3 Opus عمل می‌کند و هزینه کمتری دارد. مناسب برای پشتیبانی مشتری و انجام وظایف چندمرحله‌ای. این مدل قابلیت درک تصاویر را نیز دارد. | ۲۰۰.۰۰۰ توکن |

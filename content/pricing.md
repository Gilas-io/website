...
`gpt-4o-mini`	 | OpenAI | معادل ریالی $0.19 برای ۱ میلیون توکن | معادل ریالی $0.72 برای ۱ میلیون توکن | معادل ریالی $9 برای ۱ میلیون توکن
...
`gpt-4o-search`	 | OpenAI | معادل ریالی 3.25$ برای ۱ میلیون توکن | معادل ریالی $13 برای ۱ میلیون توکن | پشتیبانی نمی‌شود
`gpt-4o-mini-search`	 | OpenAI | معادل ریالی $0.18 برای ۱ میلیون توکن | معادل ریالی $0.78 برای ۱ میلیون توکن | پشتیبانی نمی‌شود
...
مدل‌های صوتی امکان تبدیل صوت به متن و متن به صوت رو دارا می‌باشند. این مدلها از زبان فارسی پشتیبانی می‌کنند.
...
`gpt-4o-mini-transcribe` | OpenAI | معادل ریالی $0.004 برای هر دقیقه
`gpt-4o-transcribe` | OpenAI | معادل ریالی $0.008 برای هر دقیقه

### تبدیل متن به صوت

مدل | ارایه دهنده | مصرف
---|---|----------
`tts-1` | OpenAI | معادل ریالی $0.02 برای هر ۱.۰۰۰ کاراکتر
`tts-1-hd` | OpenAI | معادل ریالی $0.04 برای هر ۱.۰۰۰ کاراکتر
`gpt-4o-mini-tts` | OpenAI | معادل ریالی $0.02 برای هر ۱ دقیقه
